...
export default function MainLayout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    ...
    { label: 'ห้องผ่าตัด (ORM)', href: '/or' },
    { label: 'คลังโลหิต (BLB)', href: '/blood-bank' },
    { label: 'ห้องฉุกเฉิน (ER)', href: '/er' },
    { label: 'ห้องปฏิบัติการ (LAB)', href: '/lab', badge: counts?.pendingLabOrders },
    { label: 'รังสีวิทยา (IME)', href: '/imaging' },
    { label: 'พยาธิวิทยา (PTH)', href: '/pathology' },
    { label: 'ผลแลบสะสม (LRM)', href: '/lab-results' },
    { label: 'ฟอกไต (HDM)', href: '/hemodialysis' },
    { label: 'ห้องหัตถการ (TRT)', href: '/treatment' },
    { label: 'ทันตกรรม (DEN)', href: '/dental' },
    { label: 'โทรเวช (TEC)', href: '/teleconsult' },
    { label: 'เคลมประกัน (CLM)', href: '/claims' },
    { label: 'ควบคุมการติดเชื้อ (INF)', href: '/infection-control' },
    { label: 'ส่งต่อ (AGN)', href: '/referring' },
    { label: 'บันทึกสุขภาพ (PHR)', href: '/phr' },
    { label: 'ลงทะเบียนล่วงหน้า (PRP)', href: '/pre-registration' },
    { label: 'นัดหมาย (APP)', href: '/appointments' },
    { label: 'รายงาน (RPT)', href: '/reports' },
